...
engine: engine.o screen.o fonts/bmtext.o objects/object.o objects/turtlecube.o objects/cube.o objects/torus.o objects/wineglass.o objects/wallelogo.o
	$(CXX) -O2 $^ -o engine -Iinclude $(LIBS)

pixeldemo: benchmarks/pixeldemo.o screen.o
	$(CXX) -O2 $^ -o pixeldemo -Iinclude $(LIBS)

triangle_test: benchmarks/triangle_test.o screen.o fonts/bmtext.o
